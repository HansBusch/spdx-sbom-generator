...
func tov23Package(p meta.Package) *v23.Package {
	return &v23.Package{
		...
		PackageLicenseConcluded: common.NoAssertion, // parser result not reliable as they assign declared license
		PackageLicenseDeclared:  p.LicenseDeclared,  //.NoAssertion,
		PackageCopyrightText:    p.Copyright,        //.NoAssertion,
